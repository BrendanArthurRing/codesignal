...
# The top voted code was


def areEquallyStrong(yourLeft, yourRight, friendsLeft, friendsRight):
    return {yourLeft, yourRight} == {friendsLeft, friendsRight}

# It uses a set to total the strength of both people and compare them, duh.


def areEquallyStrong(yourLeft, yourRight, friendsLeft, friendsRight):
    print({yourLeft, yourRight})
    print({friendsLeft, friendsRight})
    print(type({yourLeft, yourRight}))
